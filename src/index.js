...
function delegate(target, fn) {
    let arrayChildren = target.children;

    for (const value of arrayChildren) {
...
function once(target, fn) {
    ...
    target.addEventListener('click', function doItOnce() {
        fn();
        this.removeEventListener('click', doItOnce);
    })
}
